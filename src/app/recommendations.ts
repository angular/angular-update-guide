...
export const RECOMMENDATIONS: Step[] = [
  ...
  { possibleIn: 1700, necessaryAsOf: 1700, level: ApplicationComplexity.Basic, material: true, step: 'V17 update @angular/material', action: 'Run `ng update @angular/material@17` to update the Material components.' },
