...
export const RECOMMENDATIONS: Step[] = [
  ...
  { possibleIn: 500, necessaryAsOf: 550, level: 2, step: 'Whitespace', action: 'Choose a value of `off` for `preserveWhitespaces` in your `tsconfig.json` to gain the benefits of this setting, which was set to `off` by default in v6.', },
