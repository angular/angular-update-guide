...
export const RECOMMENDATIONS: Step[] = [
  ...
  { possibleIn: 600, necessaryAsOf: 600, level: 1, step: 'Update to CLI v6', action: 'Update your Angular CLI globally and locally, and migrate the configuration to the [new angular.json format](https://github.com/angular/angular-cli/wiki/angular.json)<br/>`${packageManagerGlobalInstall} @angular/cli@next`<br/>`${packageManagerInstall} @angular/cli@next`<br/>`ng update @angular/cli --from=1 --migrate-only`<br/>', },
  { possibleIn: 600, necessaryAsOf: 600, level: 1, step: 'Update to Angular v6', action: '`ng update @angular/core --next --force`', },
  { possibleIn: 600, necessaryAsOf: 600, level: 1, step: 'Update Dependencies for v6', action: '`ng update @angular/material --next`', },
  ...
  { possibleIn: 600, necessaryAsOf: 800, level: 1, step: 'remove rxjs-compat', action: 'Once you and all of your dependencies have updated to RxJS 6, you can remove `rxjs-compat`.'},
];
